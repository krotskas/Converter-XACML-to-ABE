...
public class Main {
    ...
    // Attribute:
    static String [] attrs = {"iannis"};
    static String [] attrs1 = {"iannis", "wrilas", "lexovo"};
    // Message:
    ...
    public static void main(String[] args) throws Exception {
        ...
        FAMESecretKey skey1 = cpabe.keygen(msk, attrs1);
        ...
        FAMECipherText cpt = cpabe.encrypt(String.join(" and ", attrs), message.getBytes());
        ...
        byte[] decrypted = cpabe.decrypt(skey1, cpt);
